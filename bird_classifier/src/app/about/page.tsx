        ...
        <main className="max-w-3xl mx-auto">
          <div className="bg-white/90 dark:bg-slate-800/90 rounded-xl shadow-lg overflow-hidden mb-8">
            ...
            <div className="p-6 md:p-8">
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-6">
                Our app uses advanced audio recognition technology to identify
                bird species from their songs and calls. The recognition
                algorithm has been trained on thousands of bird sound recordings
                from around the world, allowing it to identify hundreds of
                different species with high accuracy.
              </p>
