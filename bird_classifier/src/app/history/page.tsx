...
const historyItems = [
  ...
  },
  {
    ...
    confidence: 91,
    imageUrl: "/placeholder.svg?height=80&width=80&query=european starling bird",
  },
]
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50 dark:from-green-950 dark:to-blue-950">
      <div className="container mx-auto px-4 py-8">
        <header className="flex items-center mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-green-800 dark:text-green-400">Identification History</h1>
        </header>
            ...
            {historyItems.length === 0 ? (
              ...
              <ul className="divide-y divide-slate-200 dark:divide-slate-700">
                {historyItems.map((item) => (
                  ...
                  >
                    <Link href={`/bird/${item.id}`} className="flex flex-col md:flex-row md:items-center gap-4">
